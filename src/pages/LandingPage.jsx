  ...
  const testimonials = [
    {
      ...
      company: "TechCorp",
      content: "BidWisehelped us find amazing developers for our mobile app. The quality of freelancers and the bidding process made it easy to stay within budget.",
      rating: 5,
      avatar: "SJ"
    },
    {
      ...
      company: "Independent",
      content: "I've completed over 50 projects on BidWise The AI matching system consistently connects me with projects that match my skills perfectly.",
      rating: 5,
      avatar: "MC"
    },
    {
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              BidWise combines the best of traditional freelancing with
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Join thousands of satisfied clients and freelancers who trust BidWise
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-10">
            Join thousands of clients and freelancers already using BidWise to
